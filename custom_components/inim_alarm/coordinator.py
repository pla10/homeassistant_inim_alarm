...
class InimDataUpdateCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    def _async_on_websocket_update(self, event_data: dict[str, Any]) -> None:
        ...
        # If data changed, ask Home Assistant to update entities immediately
        if has_changes:
            _LOGGER.debug("Applying partial updates from WS and refreshing entities")
